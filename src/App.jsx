...
let ASSET_PARAMS = {
  ...
  // ── US Tech (nouveaux)
  "NFLX":    { mu:0.25, sigma:0.40, name:"Netflix",          type:"action", sector:"Tech",         themes:["tech","media"],               cap:350 },
  "ADBE":    { mu:0.18, sigma:0.25, name:"Adobe",            type:"action", sector:"Tech",         themes:["tech","cloud","ia"],           cap:230 },
  "NOW":     { mu:0.25, sigma:0.28, name:"ServiceNow",       type:"action", sector:"Tech",         themes:["tech","cloud"],               cap:200 },
  "SNOW":    { mu:0.20, sigma:0.55, name:"Snowflake",        type:"action", sector:"Tech",         themes:["tech","cloud","ia"],           cap:55  },
  "PLTR":    { mu:0.30, sigma:0.60, name:"Palantir",         type:"action", sector:"Tech",         themes:["tech","ia"],                  cap:80  },
  "UBER":    { mu:0.25, sigma:0.35, name:"Uber",             type:"action", sector:"Tech",         themes:["tech","auto"],                cap:170 },
  "ABNB":    { mu:0.15, sigma:0.40, name:"Airbnb",           type:"action", sector:"Tech",         themes:["tech"],                       cap:80  },
  "AVGO":    { mu:0.30, sigma:0.28, name:"Broadcom",         type:"action", sector:"Tech",         themes:["tech","semi","ia"],           cap:800 },
  "QCOM":    { mu:0.15, sigma:0.28, name:"Qualcomm",         type:"action", sector:"Tech",         themes:["tech","semi"],                cap:170 },
  "AMAT":    { mu:0.25, sigma:0.35, name:"Applied Materials",type:"action", sector:"Tech",         themes:["tech","semi"],                cap:190 },
  "TXN":     { mu:0.12, sigma:0.20, name:"Texas Instruments",type:"action", sector:"Tech",         themes:["tech","semi"],                cap:160 },
  "TSM":     { mu:0.18, sigma:0.28, name:"Taiwan Semi.",     type:"action", sector:"Tech",         themes:["tech","semi","asie"],         cap:720 },
  "SPOT":    { mu:0.20, sigma:0.45, name:"Spotify",          type:"action", sector:"Tech",         themes:["tech","media"],               cap:100 },
  "INTU":    { mu:0.20, sigma:0.22, name:"Intuit",           type:"action", sector:"Tech",         themes:["tech","cloud","fintech"],     cap:180 },
  "NET":     { mu:0.25, sigma:0.45, name:"Cloudflare",       type:"action", sector:"Tech",         themes:["tech","cloud","cyber"],       cap:65  },
  "ZS":      { mu:0.22, sigma:0.40, name:"Zscaler",          type:"action", sector:"Tech",         themes:["tech","cyber","cloud"],       cap:25  },
  "CSCO":    { mu:0.08, sigma:0.16, name:"Cisco",            type:"action", sector:"Tech",         themes:["tech","telecom"],             cap:230 },
  "ACN":     { mu:0.15, sigma:0.16, name:"Accenture",        type:"action", sector:"Tech",         themes:["tech","cloud"],               cap:210 },
  "IBM":     { mu:0.08, sigma:0.18, name:"IBM",              type:"action", sector:"Tech",         themes:["tech","cloud","ia"],          cap:160 },
  // ── US Finance (nouveaux)
  "BAC":     { mu:0.12, sigma:0.22, name:"Bank of America",  type:"action", sector:"Finance",      themes:["finance","banque"],           cap:340 },
  "WFC":     { mu:0.10, sigma:0.22, name:"Wells Fargo",      type:"action", sector:"Finance",      themes:["finance","banque"],           cap:225 },
  "MS":      { mu:0.14, sigma:0.22, name:"Morgan Stanley",   type:"action", sector:"Finance",      themes:["finance","banque"],           cap:195 },
  "C":       { mu:0.08, sigma:0.25, name:"Citigroup",        type:"action", sector:"Finance",      themes:["finance","banque"],           cap:145 },
  "AXP":     { mu:0.18, sigma:0.20, name:"American Express", type:"action", sector:"Finance",      themes:["finance","paiement"],         cap:175 },
  "SCHW":    { mu:0.10, sigma:0.25, name:"Charles Schwab",   type:"action", sector:"Finance",      themes:["finance"],                    cap:135 },
  "BLK":     { mu:0.15, sigma:0.20, name:"BlackRock",        type:"action", sector:"Finance",      themes:["finance"],                    cap:135 },
  "SPGI":    { mu:0.18, sigma:0.18, name:"S&P Global",       type:"action", sector:"Finance",      themes:["finance"],                    cap:155 },
  "ICE":     { mu:0.14, sigma:0.16, name:"Intercontinental", type:"action", sector:"Finance",      themes:["finance"],                    cap:100 },
  "CME":     { mu:0.12, sigma:0.16, name:"CME Group",        type:"action", sector:"Finance",      themes:["finance"],                    cap:80  },
  "AFL":     { mu:0.10, sigma:0.16, name:"Aflac",            type:"action", sector:"Finance",      themes:["finance","assurance"],        cap:60  },
  // ── US Santé (nouveaux)
  "ABBV":    { mu:0.14, sigma:0.18, name:"AbbVie",           type:"action", sector:"Santé",        themes:["sante","pharma","biotech"],   cap:275 },
  "MRK":     { mu:0.10, sigma:0.16, name:"Merck",            type:"action", sector:"Santé",        themes:["sante","pharma"],             cap:240 },
  "AMGN":    { mu:0.10, sigma:0.18, name:"Amgen",            type:"action", sector:"Santé",        themes:["sante","biotech"],            cap:150 },
  "BMY":     { mu:0.06, sigma:0.18, name:"Bristol-Myers",    type:"action", sector:"Santé",        themes:["sante","pharma","biotech"],   cap:130 },
  "GILD":    { mu:0.06, sigma:0.18, name:"Gilead Sciences",  type:"action", sector:"Santé",        themes:["sante","biotech"],            cap:115 },
  "MDT":     { mu:0.06, sigma:0.16, name:"Medtronic",        type:"action", sector:"Santé",        themes:["sante","medtech"],            cap:100 },
  "REGN":    { mu:0.15, sigma:0.22, name:"Regeneron",        type:"action", sector:"Santé",        themes:["sante","biotech"],            cap:90  },
  "VRTX":    { mu:0.22, sigma:0.22, name:"Vertex Pharma.",   type:"action", sector:"Santé",        themes:["sante","biotech","pharma"],   cap:115 },
  "CVS":     { mu:0.06, sigma:0.18, name:"CVS Health",       type:"action", sector:"Santé",        themes:["sante"],                      cap:85  },
  "ELV":     { mu:0.14, sigma:0.16, name:"Elevance Health",  type:"action", sector:"Santé",        themes:["sante","assurance"],          cap:95  },
  "SYK":     { mu:0.15, sigma:0.18, name:"Stryker",          type:"action", sector:"Santé",        themes:["sante","medtech"],            cap:145 },
  "BSX":     { mu:0.15, sigma:0.18, name:"Boston Scientific",type:"action", sector:"Santé",        themes:["sante","medtech"],            cap:125 },
  // ── US Énergie (nouveaux)
  "SLB":     { mu:0.08, sigma:0.25, name:"SLB",              type:"action", sector:"Énergie",      themes:["energie","petrole"],          cap:65  },
  "EOG":     { mu:0.10, sigma:0.28, name:"EOG Resources",    type:"action", sector:"Énergie",      themes:["energie","petrole"],          cap:75  },
  "MPC":     { mu:0.15, sigma:0.25, name:"Marathon Petro.",  type:"action", sector:"Énergie",      themes:["energie","petrole"],          cap:65  },
  "VLO":     { mu:0.14, sigma:0.25, name:"Valero Energy",    type:"action", sector:"Énergie",      themes:["energie","petrole"],          cap:55  },
  "HAL":     { mu:0.08, sigma:0.30, name:"Halliburton",      type:"action", sector:"Énergie",      themes:["energie","petrole"],          cap:30  },
  // ── US Conso. discrétionnaire (nouveaux)
  "SBUX":    { mu:0.10, sigma:0.22, name:"Starbucks",        type:"action", sector:"Conso.",       themes:["conso"],                      cap:100 },
  "MCD":     { mu:0.12, sigma:0.14, name:"McDonald's",       type:"action", sector:"Conso.",       themes:["conso"],                      cap:220 },
  "DIS":     { mu:0.06, sigma:0.25, name:"Disney",           type:"action", sector:"Conso.",       themes:["conso","media","gaming"],     cap:200 },
  "COST":    { mu:0.16, sigma:0.16, name:"Costco",           type:"action", sector:"Conso.",       themes:["conso"],                      cap:390 },
  "HD":      { mu:0.14, sigma:0.18, name:"Home Depot",       type:"action", sector:"Conso.",       themes:["conso"],                      cap:380 },
  "LOW":     { mu:0.14, sigma:0.20, name:"Lowe's",           type:"action", sector:"Conso.",       themes:["conso"],                      cap:150 },
  "TJX":     { mu:0.14, sigma:0.16, name:"TJX Companies",    type:"action", sector:"Conso.",       themes:["conso"],                      cap:140 },
  "BKNG":    { mu:0.18, sigma:0.25, name:"Booking Holdings", type:"action", sector:"Conso.",       themes:["conso"],                      cap:175 },
  "LULU":    { mu:0.20, sigma:0.35, name:"Lululemon",        type:"action", sector:"Conso.",       themes:["conso","luxe"],               cap:45  },
  "F":       { mu:0.05, sigma:0.30, name:"Ford Motor",       type:"action", sector:"Conso.",       themes:["conso","auto","ve"],          cap:50  },
  // ── US Conso. défensive (nouveaux)
  "WMT":     { mu:0.14, sigma:0.14, name:"Walmart",          type:"action", sector:"Conso. déf.", themes:["conso","refuge","value"],     cap:720 },
  "MDLZ":    { mu:0.08, sigma:0.14, name:"Mondelez",         type:"action", sector:"Conso. déf.", themes:["conso","refuge"],             cap:80  },
  // ── US Industrie (nouveaux)
  "RTX":     { mu:0.10, sigma:0.18, name:"RTX Corp.",        type:"action", sector:"Industrie",    themes:["industrie","defense"],        cap:165 },
  "GE":      { mu:0.20, sigma:0.28, name:"GE Aerospace",     type:"action", sector:"Industrie",    themes:["industrie"],                  cap:190 },
  "HON":     { mu:0.10, sigma:0.16, name:"Honeywell",        type:"action", sector:"Industrie",    themes:["industrie"],                  cap:145 },
  "DE":      { mu:0.14, sigma:0.22, name:"John Deere",       type:"action", sector:"Industrie",    themes:["industrie"],                  cap:120 },
  "UPS":     { mu:0.08, sigma:0.18, name:"UPS",              type:"action", sector:"Industrie",    themes:["industrie","logistique"],     cap:130 },
  "NOC":     { mu:0.10, sigma:0.14, name:"Northrop Grumman", type:"action", sector:"Industrie",    themes:["industrie","defense","space"],cap:75  },
  // ── US Immobilier (nouveaux)
  "O":       { mu:0.07, sigma:0.14, name:"Realty Income",    type:"action", sector:"Immobilier",   themes:["immo","refuge"],              cap:55  },
  "PSA":     { mu:0.08, sigma:0.16, name:"Public Storage",   type:"action", sector:"Immobilier",   themes:["immo"],                       cap:55  },
  // ── US Matériaux (nouveaux)
  "APD":     { mu:0.10, sigma:0.18, name:"Air Products",     type:"action", sector:"Matériaux",    themes:["materiaux","industrie"],      cap:55  },
  "ECL":     { mu:0.10, sigma:0.16, name:"Ecolab",           type:"action", sector:"Matériaux",    themes:["materiaux","eau"],            cap:55  },
  "DOW":     { mu:0.06, sigma:0.20, name:"Dow Inc.",         type:"action", sector:"Matériaux",    themes:["materiaux"],                  cap:40  },
  "NUE":     { mu:0.12, sigma:0.28, name:"Nucor",            type:"action", sector:"Matériaux",    themes:["materiaux"],                  cap:40  },
  // ── US Utilities (nouveaux)
  "AEP":     { mu:0.06, sigma:0.12, name:"American El. Pow.",type:"action", sector:"Utilities",    themes:["energie","nucleaire"],        cap:55  },
  // ── US Télécom (nouveaux)
  "T":       { mu:0.02, sigma:0.16, name:"AT&T",             type:"action", sector:"Télécom",      themes:["telecom"],                    cap:175 },
  // ── Europe
  "ASML":    { mu:0.25, sigma:0.28, name:"ASML Holding",     type:"action", sector:"Tech",         themes:["tech","semi","europe"],       cap:350 },
  "SAP":     { mu:0.18, sigma:0.20, name:"SAP",              type:"action", sector:"Tech",         themes:["tech","cloud","europe"],      cap:250 },
  "NVO":     { mu:0.30, sigma:0.25, name:"Novo Nordisk",     type:"action", sector:"Santé",        themes:["sante","pharma","europe"],    cap:370 },
  "AIR.PA":  { mu:0.14, sigma:0.28, name:"Airbus",           type:"action", sector:"Industrie",    themes:["industrie","defense","europe"],cap:145},
  "TTE.PA":  { mu:0.08, sigma:0.18, name:"TotalEnergies",    type:"action", sector:"Énergie",      themes:["energie","petrole","europe"], cap:155 },
  "RMS.PA":  { mu:0.18, sigma:0.22, name:"Hermès",           type:"action", sector:"Conso.",       themes:["conso","luxe","europe"],      cap:210 },
  "AZN":     { mu:0.14, sigma:0.18, name:"AstraZeneca",      type:"action", sector:"Santé",        themes:["sante","pharma","europe"],    cap:240 },
  "SHEL":    { mu:0.08, sigma:0.18, name:"Shell",            type:"action", sector:"Énergie",      themes:["energie","petrole","europe"], cap:220 },
  "OR.PA":   { mu:0.12, sigma:0.16, name:"L'Oréal",          type:"action", sector:"Conso.",       themes:["conso","luxe","europe"],      cap:200 },
  "BNP.PA":  { mu:0.10, sigma:0.22, name:"BNP Paribas",      type:"action", sector:"Finance",      themes:["finance","banque","europe"],  cap:90  },
  "SIE.DE":  { mu:0.12, sigma:0.20, name:"Siemens",          type:"action", sector:"Industrie",    themes:["industrie","europe"],         cap:130 },
  "VOW.DE":  { mu:0.04, sigma:0.28, name:"Volkswagen",       type:"action", sector:"Conso.",       themes:["conso","auto","ve","europe"], cap:60  },
  "INGA.AS": { mu:0.10, sigma:0.22, name:"ING Group",        type:"action", sector:"Finance",      themes:["finance","banque","europe"],  cap:70  },
  "NSRGY":   { mu:0.06, sigma:0.12, name:"Nestlé",           type:"action", sector:"Conso. déf.", themes:["conso","refuge","europe"],    cap:250 },
  // ── Asie
  "TM":      { mu:0.08, sigma:0.18, name:"Toyota",           type:"action", sector:"Conso.",       themes:["conso","auto","ve","asie"],   cap:250 },
  "SONY":    { mu:0.12, sigma:0.22, name:"Sony",             type:"action", sector:"Tech",         themes:["tech","gaming","media","asie"],cap:120},
  "BABA":    { mu:0.05, sigma:0.40, name:"Alibaba",          type:"action", sector:"Tech",         themes:["tech","cloud","asie","emergent"],cap:210},
  "SE":      { mu:0.10, sigma:0.60, name:"Sea Limited",      type:"action", sector:"Tech",         themes:["tech","gaming","asie","emergent"],cap:45},
  "BYDDY":   { mu:0.18, sigma:0.45, name:"BYD",              type:"action", sector:"Conso.",       themes:["conso","auto","ve","asie"],   cap:100 },
  "9984.T":  { mu:0.08, sigma:0.35, name:"SoftBank",         type:"action", sector:"Finance",      themes:["finance","tech","asie"],      cap:75  },
  // ── Crypto (nouveaux)
  "ADA-USD": { mu:0.20, sigma:1.10, name:"Cardano",          type:"crypto", sector:"Crypto",       themes:["crypto","defi"],              cap:18  },
  "AVAX-USD":{ mu:0.40, sigma:1.10, name:"Avalanche",        type:"crypto", sector:"Crypto",       themes:["crypto","defi"],              cap:15  },
  "LINK-USD":{ mu:0.35, sigma:1.00, name:"Chainlink",        type:"crypto", sector:"Crypto",       themes:["crypto","defi"],              cap:10  },
  "DOT-USD": { mu:0.20, sigma:1.00, name:"Polkadot",         type:"crypto", sector:"Crypto",       themes:["crypto","defi"],              cap:12  },
  "MATIC-USD":{ mu:0.25, sigma:1.20,name:"Polygon",          type:"crypto", sector:"Crypto",       themes:["crypto","defi"],              cap:10  },
  "UNI-USD": { mu:0.20, sigma:1.00, name:"Uniswap",          type:"crypto", sector:"Crypto",       themes:["crypto","defi"],              cap:8   },
  "FIL-USD": { mu:0.10, sigma:1.10, name:"Filecoin",         type:"crypto", sector:"Crypto",       themes:["crypto"],                     cap:5   },
  "ATOM-USD":{ mu:0.20, sigma:1.00, name:"Cosmos",           type:"crypto", sector:"Crypto",       themes:["crypto","defi"],              cap:5   },
  // ── ETF (nouveaux)
  "IWM":     { mu:0.10, sigma:0.18, name:"Russell 2000 ETF", type:"etf",    sector:"ETF",          themes:["etf","marche"],               cap:45  },
  "EFA":     { mu:0.08, sigma:0.14, name:"MSCI EAFE ETF",    type:"etf",    sector:"ETF",          themes:["etf","europe","asie"],        cap:100 },
  "EEM":     { mu:0.08, sigma:0.18, name:"Émergents ETF",    type:"etf",    sector:"ETF",          themes:["etf","emergent"],             cap:45  },
  "TLT":     { mu:0.02, sigma:0.12, name:"Treasury 20+ ETF", type:"etf",    sector:"ETF",          themes:["etf","obligations","refuge"],  cap:30  },
  "LQD":     { mu:0.04, sigma:0.08, name:"Corp Bond ETF",    type:"etf",    sector:"ETF",          themes:["etf","obligations"],           cap:30  },
  "HYG":     { mu:0.05, sigma:0.10, name:"High Yield ETF",   type:"etf",    sector:"ETF",          themes:["etf","obligations"],           cap:15  },
  "SOXX":    { mu:0.22, sigma:0.28, name:"Semiconducteurs ETF",type:"etf",  sector:"ETF",          themes:["etf","semi","tech"],          cap:25  },
  "GDX":     { mu:0.06, sigma:0.30, name:"Gold Miners ETF",  type:"etf",    sector:"ETF",          themes:["etf","or","refuge"],          cap:15  },
  "SCHD":    { mu:0.11, sigma:0.14, name:"Schwab Dividend",  type:"etf",    sector:"ETF",          themes:["etf","marche","refuge"],      cap:60  },
  "JEPI":    { mu:0.08, sigma:0.10, name:"JPM Equity Prem.", type:"etf",    sector:"ETF",          themes:["etf","marche"],               cap:35  },
  "IAU":     { mu:0.08, sigma:0.12, name:"Gold Trust ETF",   type:"etf",    sector:"ETF",          themes:["etf","or","refuge"],          cap:30  },
  "SLV":     { mu:0.06, sigma:0.22, name:"Silver ETF",       type:"etf",    sector:"ETF",          themes:["etf","materiaux","refuge"],   cap:12  },
  "MCHI":    { mu:0.05, sigma:0.25, name:"MSCI China ETF",   type:"etf",    sector:"ETF",          themes:["etf","asie","emergent"],      cap:5   },
  "EWJ":     { mu:0.07, sigma:0.14, name:"MSCI Japan ETF",   type:"etf",    sector:"ETF",          themes:["etf","asie"],                 cap:15  },
  "EWZ":     { mu:0.05, sigma:0.30, name:"MSCI Brazil ETF",  type:"etf",    sector:"ETF",          themes:["etf","emergent"],             cap:5   },
  "QQQM":    { mu:0.18, sigma:0.18, name:"Nasdaq 100 Mini",  type:"etf",    sector:"ETF",          themes:["etf","tech"],                 cap:30  },
  "XLK":     { mu:0.18, sigma:0.20, name:"Tech Sector ETF",  type:"etf",    sector:"ETF",          themes:["etf","tech"],                 cap:70  },
  "XLV":     { mu:0.11, sigma:0.14, name:"Health Care ETF",  type:"etf",    sector:"ETF",          themes:["etf","sante"],                cap:40  },
  "XLRE":    { mu:0.08, sigma:0.18, name:"Real Estate ETF",  type:"etf",    sector:"ETF",          themes:["etf","immo"],                 cap:10  },
  "XLP":     { mu:0.08, sigma:0.12, name:"Cons. Staples ETF",type:"etf",    sector:"ETF",          themes:["etf","conso","refuge"],       cap:15  },
  "IVV":     { mu:0.13, sigma:0.14, name:"S&P 500 iShares",  type:"etf",    sector:"ETF",          themes:["etf","marche"],               cap:550 },
  "VTI":     { mu:0.13, sigma:0.14, name:"Vanguard Total Mkt",type:"etf",   sector:"ETF",          themes:["etf","marche"],               cap:450 },
  "EWG":     { mu:0.09, sigma:0.18, name:"MSCI Germany ETF", type:"etf",    sector:"ETF",          themes:["etf","europe"],               cap:7   },
  "IEMG":    { mu:0.08, sigma:0.18, name:"Core Émergents ETF",type:"etf",   sector:"ETF",          themes:["etf","emergent"],             cap:80  },
};
...
function ShareModal({imgSrc,loading,tab,shareUrl,T,onClose}){
  ...
  const shareText='Portfolio on IndexLab — indexlab.finance';
  ...
  async function handleShare(){
    if(canShare){
      try{
        ...
        else await navigator.share({title:'IndexLab',url:linkUrl});
      }catch(e){}
    } else {
      setSocialOpen(s=>!s);
    }
  ...
  const socials=[
    {label:'𝕏 Post',  bg:'#000',     href:`https://twitter.com/intent/tweet?text=${encodeURIComponent(shareText)}&url=${encodeURIComponent(linkUrl)}`},
    {label:'WhatsApp',bg:'#25d366',  href:`https://wa.me/?text=${encodeURIComponent(shareText+' '+linkUrl)}`},
    {label:'Telegram',bg:'#229ed9',  href:`https://t.me/share/url?url=${encodeURIComponent(linkUrl)}&text=${encodeURIComponent(shareText)}`},
